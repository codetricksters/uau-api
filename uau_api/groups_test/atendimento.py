...
class Atendimento:
    ...
    def gerar_pendencia(
        ...
        Endpoint: `/api/v{version}/Atendimento/GerarPendencia`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/GerarPendencia"
        kwargs = {
            "request": request,
    ...
    def gravar_atendimento(
        ...
        """
        1. Autenticar o usuário cliente URI + /api/v{version}/Autenticador/AutenticarUsuario
        2. Consultar os dados do usuário logado para obter o código do cliente URI + /api/v{version}/Atendimento/GravarAtendimento
        3. Preencher os parâmetros de request para uso do método.
        
        Definição de Negócio:
        Permite Gravar o Atendimento.
        1. Deve montar uma estrutura com as informações do Atendimento verificando os parâmetros obrigatórios.
        2. Será apenas registrado Atendimentos com o status [0 - Em Aberto].
        3. Caso não seja informado: usrrespon_atd, numccm_atd e usrcad_atd, será obrigatório ter configurado o serviço atendimento uauweb no CRM. CRM - Utilitários - Configurações de serviço
        4. Para informar a unidade do atendimento é obrigatório informar a empresa, obra e produto. Caso não informe a empresa, vamos desconsiderar essa informação e gravar o atendimento.
        
        VirtUau:
        - https://ajuda.globaltec.com.br/virtuau/configuracao-de-atendimento-do-uau-web/
        
        Endpoint: `/api/v{version}/Atendimento/GravarAtendimento`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/GravarAtendimento"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_pendencia(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarPendencia`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarPendencia"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_atendimento(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarAtendimento`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarAtendimento"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_categ_de_coment_ativas(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarCategDeComentAtivas`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarCategDeComentAtivas"
        kwargs = {
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
        }
    ...
    def consultar_pendencia_observacao(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarPendenciaObservacao`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarPendenciaObservacao"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def vincular_arquivo_ao_atendimento(
        ...
        Endpoint: `/api/v{version}/Atendimento/VincularArquivoAoAtendimento`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/VincularArquivoAoAtendimento"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_atendimento_por_pessoa(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarAtendimentoPorPessoa`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarAtendimentoPorPessoa"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_empreendimentos_cliente(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarEmpreendimentosCliente`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarEmpreendimentosCliente"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_categoria_atendimento_web(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarCategoriaAtendimentoWeb`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarCategoriaAtendimentoWeb"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_numero_work_flow_vinculado(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarNumeroWorkFlowVinculado`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarNumeroWorkFlowVinculado"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_pendencias_por_numero_vinculo(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarPendenciasPorNumeroVinculo`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarPendenciasPorNumeroVinculo"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def gerar_atendimento_por_chat_online_cliente(
        ...
        Endpoint: `/api/v{version}/Atendimento/GerarAtendimentoPorChatOnlineCliente`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/GerarAtendimentoPorChatOnlineCliente"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_atendimento_detalhado_por_chave(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarAtendimentoDetalhadoPorChave`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarAtendimentoDetalhadoPorChave"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_configuracao_atendimento_uauweb(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarConfiguracaoAtendimentoUAUWEB`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarConfiguracaoAtendimentoUAUWEB"
        kwargs = {
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
        }
    ...
    def consultar_atendimento_por_categorias_uau_web(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarAtendimentoPorCategoriasUauWeb`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarAtendimentoPorCategoriasUauWeb"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_atendimento_por_pessoa_comentario(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarAtendimentoPorPessoaComentario`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarAtendimentoPorPessoaComentario"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_unidades_do_empreendimento_cliente(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarUnidadesDoEmpreendimentoCliente`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarUnidadesDoEmpreendimentoCliente"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_data_prevista_de_termino_atendimento(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarDataPrevistaDeTerminoAtendimento`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarDataPrevistaDeTerminoAtendimento"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
    ...
    def consultar_numero_vinculo_categoria_de_comentario_com_work_flow(
        ...
        Endpoint: `/api/v{version}/Atendimento/ConsultarNumeroVinculoCategoriaDeComentarioComWorkFlow`
        HTTP Method: `POST`
        ...
        Examples:
            ...
            ... )
        """
        path = f"/api/v{version}/Atendimento/ConsultarNumeroVinculoCategoriaDeComentarioComWorkFlow"
        kwargs = {
            "request": request,
            "Authorization": authorization,
            "X-INTEGRATION-Authorization": x_integration_authorization,
