    ...
    def buscar_plano_indexador(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("buscar_plano_indexador::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("buscar_plano_indexador::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("buscar_plano_indexador::Success, but response is not a JSON object. {response.text}")
                return None
    ...
    def consultar_modelo_venda(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_modelo_venda::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_modelo_venda::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_modelo_venda::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def gerar_parcelas_proposta(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("gerar_parcelas_proposta::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("gerar_parcelas_proposta::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("gerar_parcelas_proposta::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_modelo_de_venda(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_modelo_de_venda::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_modelo_de_venda::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_modelo_de_venda::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def montar_modelo_renegociacao(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("montar_modelo_renegociacao::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("montar_modelo_renegociacao::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("montar_modelo_renegociacao::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_parcelas_modelo_venda(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_parcelas_modelo_venda::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_parcelas_modelo_venda::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_parcelas_modelo_venda::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_modelo_de_venda_seguro_por_chave(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_modelo_de_venda_seguro_por_chave::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_modelo_de_venda_seguro_por_chave::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_modelo_de_venda_seguro_por_chave::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
