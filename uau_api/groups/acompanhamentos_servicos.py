    ...
    def acompanhar_contrato(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("acompanhar_contrato::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("acompanhar_contrato::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("acompanhar_contrato::Success, but response is not a JSON object. {response.text}")
                return None
    ...
    def acompanhar_servico_pl(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("acompanhar_servico_pl::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("acompanhar_servico_pl::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("acompanhar_servico_pl::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def acompanhar_servico_orcado(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("acompanhar_servico_orcado::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("acompanhar_servico_orcado::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("acompanhar_servico_orcado::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def acompanhar_servico_contrato(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("acompanhar_servico_contrato::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("acompanhar_servico_contrato::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("acompanhar_servico_contrato::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def excluir_acompanhamento_servico_pl(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("excluir_acompanhamento_servico_pl::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("excluir_acompanhamento_servico_pl::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("excluir_acompanhamento_servico_pl::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def excluir_acompanhamento_servico_orcado(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("excluir_acompanhamento_servico_orcado::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("excluir_acompanhamento_servico_orcado::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("excluir_acompanhamento_servico_orcado::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def alterar_acompanhamento_servico_contrato(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("alterar_acompanhamento_servico_contrato::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("alterar_acompanhamento_servico_contrato::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("alterar_acompanhamento_servico_contrato::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def excluir_acompanhamento_servico_de_contrato(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("excluir_acompanhamento_servico_de_contrato::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("excluir_acompanhamento_servico_de_contrato::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("excluir_acompanhamento_servico_de_contrato::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def excluir_acompanhamento_servico_orcado_por_chave(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("excluir_acompanhamento_servico_orcado_por_chave::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("excluir_acompanhamento_servico_orcado_por_chave::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("excluir_acompanhamento_servico_orcado_por_chave::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_acompanhamento_contrato_servico_por_servico(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_acompanhamento_contrato_servico_por_servico::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_acompanhamento_contrato_servico_por_servico::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_acompanhamento_contrato_servico_por_servico::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_acompanhamento_contrato_servico_por_contrato_eservico(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_acompanhamento_contrato_servico_por_contrato_eservico::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_acompanhamento_contrato_servico_por_contrato_eservico::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_acompanhamento_contrato_servico_por_contrato_eservico::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
