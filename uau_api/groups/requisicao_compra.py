            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("aprovar_requisicoes_compra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("aprovar_requisicoes_compra::Server returned an error")
                    return None
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("desaprovar_requisicoes_compra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("desaprovar_requisicoes_compra::Server returned an error")
                    return None
