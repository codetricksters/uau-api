    ...
    def atualizar_item_cotacao(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("atualizar_item_cotacao::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("atualizar_item_cotacao::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("atualizar_item_cotacao::Success, but response is not a JSON object. {response.text}")
                return None
    ...
    def conta_cotacoes_aprov_mob(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("conta_cotacoes_aprov_mob::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("conta_cotacoes_aprov_mob::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("conta_cotacoes_aprov_mob::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def aprovar_simulacoes_compra(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("aprovar_simulacoes_compra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("aprovar_simulacoes_compra::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("aprovar_simulacoes_compra::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def adicionar_fornecedor_cotacao(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("adicionar_fornecedor_cotacao::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("adicionar_fornecedor_cotacao::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("adicionar_fornecedor_cotacao::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def buscar_itens_cotacao_fornecedor(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("buscar_itens_cotacao_fornecedor::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("buscar_itens_cotacao_fornecedor::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("buscar_itens_cotacao_fornecedor::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_itens_cotacao_por_obra(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_itens_cotacao_por_obra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_itens_cotacao_por_obra::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_itens_cotacao_por_obra::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def buscar_cotacao_aberta_fornecedor(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("buscar_cotacao_aberta_fornecedor::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("buscar_cotacao_aberta_fornecedor::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("buscar_cotacao_aberta_fornecedor::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def aprovar_confirmacao_cotacao_por_obra(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("aprovar_confirmacao_cotacao_por_obra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("aprovar_confirmacao_cotacao_por_obra::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("aprovar_confirmacao_cotacao_por_obra::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def remover_aprovacao_simulacoes_compra(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("remover_aprovacao_simulacoes_compra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("remover_aprovacao_simulacoes_compra::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("remover_aprovacao_simulacoes_compra::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def atualizar_condicao_pagamento_entrega(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("atualizar_condicao_pagamento_entrega::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("atualizar_condicao_pagamento_entrega::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("atualizar_condicao_pagamento_entrega::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_aprovacao_da_cotacao_por_obra(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_aprovacao_da_cotacao_por_obra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_aprovacao_da_cotacao_por_obra::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_aprovacao_da_cotacao_por_obra::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def reprovar_confirmacoes_cotacao_por_obra(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("reprovar_confirmacoes_cotacao_por_obra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("reprovar_confirmacoes_cotacao_por_obra::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("reprovar_confirmacoes_cotacao_por_obra::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_cotacoes_confirmacao_pendente(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_cotacoes_confirmacao_pendente::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_cotacoes_confirmacao_pendente::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_cotacoes_confirmacao_pendente::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_quantidade_cotacao_pendente_por_obra(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_quantidade_cotacao_pendente_por_obra::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_quantidade_cotacao_pendente_por_obra::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_quantidade_cotacao_pendente_por_obra::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_quantidade_cotacao_pendente_por_obra_mob(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_quantidade_cotacao_pendente_por_obra_mob::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_quantidade_cotacao_pendente_por_obra_mob::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_quantidade_cotacao_pendente_por_obra_mob::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_justificativas_aprovacao_fora_sequencia(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_justificativas_aprovacao_fora_sequencia::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_justificativas_aprovacao_fora_sequencia::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_justificativas_aprovacao_fora_sequencia::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def inserir_altera_coment_forn_frete(
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("inserir_altera_coment_forn_frete::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("inserir_altera_coment_forn_frete::Server returned an error")
                    return None
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("inserir_altera_coment_forn_frete::Success, but response is not a JSON object. {response.text}")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
