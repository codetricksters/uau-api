            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("by_token::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("by_token::Server returned an error")
                    return None
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("atualizar_recebimento_pix::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("atualizar_recebimento_pix::Server returned an error")
                    return None
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("atualizar_pedido_rec::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("atualizar_pedido_rec::Server returned an error")
                    return None
