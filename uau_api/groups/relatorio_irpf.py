            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("gerar_pdfrel_irpf::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("gerar_pdfrel_irpf::Server returned an error")
                    return None
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("gerar_pdfrel_irpfv2::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("gerar_pdfrel_irpfv2::Server returned an error")
                    return None
