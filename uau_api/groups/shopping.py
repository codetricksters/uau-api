            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("grava_rendimentos::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("grava_rendimentos::Server returned an error")
                    return None
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("importacao_de_parcelas::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("importacao_de_parcelas::Server returned an error")
                    return None
            ...
            if response.status_code in [HTTPStatus.BAD_REQUEST, HTTPStatus.INTERNAL_SERVER_ERROR]:
                ...
                try:
                    ...
                    if isinstance(error_data, (dict, list)):
                        ...
                        print("consultar_rendimento_lojista::Is not dict or list, but it's not a JSON object.")
                        return None
                except ValueError:
                    print("consultar_rendimento_lojista::Server returned an error")
                    return None
