    ...
    def consultar_vendedores(
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_vendedores::Success, but response is not a JSON object.")
                return None
    ...
    def atualizar_status_comissao(
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("atualizar_status_comissao::Success, but response is not a JSON object.")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_modelo_comissao(
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_modelo_comissao::Success, but response is not a JSON object.")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
    ...
    def consultar_estrutura_comissao(
        ...
        try:
            ...
            if isinstance(json_data, (list, dict)):
                ...
                print("consultar_estrutura_comissao::Success, but response is not a JSON object.")
                return None
        except ValueError as json_err:
            print(f"Failed to parse JSON: {json_err}")
            return None
