    ...
    for class_name, methods in api_classes.items():
        ...
        with open(file_path, 'w', encoding='utf-8') as f:
            ...
            for method in methods:
                ...
                f.write('                    else:\n')
                f.write(f'                        print("{method_name}::Is not dict or list, but it\'s not a JSON object.")\n')
                f.write('                        return None\n')
                f.write('                except ValueError:\n')
                f.write(f'                    print("{method_name}::Server returned an error")\n')
                f.write('                    return None\n')
                f.write('            \n')
                ...
                f.write('            except ValueError:\n')
                f.write('                print(f"Server returned {http_err}")\n')
                f.write('                return None\n')
