    ...
    for class_name, methods in api_classes.items():
        ...
        with open(file_path, 'w', encoding='utf-8') as f:
            ...
            for method in methods:
                ...
                f.write('                    if isinstance(error_data, dict):\n')
                f.write('                        # Extract the specific error fields if they exist\n')
                f.write('                        detalhe = error_data.get("Detalhe", "N/A")\n')
                f.write('                        mensagem = error_data.get("Mensagem", "N/A")\n')
                f.write('                        descricao = error_data.get("Descricao", "N/A")\n')
                f.write('                        \n')
                f.write('                        print("Error Details:")\n')
